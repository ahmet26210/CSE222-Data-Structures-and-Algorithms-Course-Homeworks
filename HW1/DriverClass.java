...
public class DriverClass {
	...
	public static void menu(Company company){
		...
		try{
			...
			System.out.println("--------------------------------------------------");
			for(int i=0 ; i < company.getBranch().getUsed() ; ++i)
	        ...
	        Branch branch = new Branch(company,1);
	         ...
	         System.out.println("--------------------------------------------------");
	         branch = new Branch(company,2);
	         if((index = company.getBranch().contains(branch)) != -1)
	             printAllBranchEmployees(company.getBranch().at(index));
	         else
	             System.out.println("Branch could not found!");
	         System.out.println("--------------------------------------------------");
	         branch = new Branch(company,2);
	         ...
	         System.out.println("--------------------------------------------------");
	         branch = new Branch(company,2);
	         BranchEmployee employee=company.getBranch().at(2).getBranchEmployee().at(1);
	         employee = company.getBranch().at(index).getBranchEmployee().at(index1);
	         if((index = company.getBranch().contains(branch)) != -1) {
	         ...
	         if((index = company.getBranch().contains(branch)) != -1)
	             ...
	             System.out.println("Branch could not found!");
	         System.out.println("--------------------------------------------------");
	         Customer customer=company.getBranch().at(2).getCompany().getCustomer().at(1);
	         ...
	         System.out.println("After Make Sales");
	         employee.makeSales("Alis","Qurtua",123456,"AlisQurtua@gmail.com","13235123212","3",desks,1,1);
	         employee.accesPreviousOrders("Alis","Qurtua",123456,"AlisQurtua@gmail.com","13235123212","3");
	         System.out.println("----------------------------------------------------------------");
